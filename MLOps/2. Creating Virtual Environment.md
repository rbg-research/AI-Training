...
[``virtualenv``](https://virtualenv.pypa.io/en/latest/)  (for Python 3) allows you to manage separate package installations for different projects. It creates a “virtual” isolated Python installation. When you switch projects, you can create a new virtual environment which is isolated from other virtual environments. You benefit from the virtual environment since packages can be installed confidently and will not interfere with another project’s environment.
...
```
virtualenv --python=python3.12 ~/environments/[CUSTOM_ENV_NAME]
```
`virtualenv` will create a virtual Python installation in the `environments` folder.
