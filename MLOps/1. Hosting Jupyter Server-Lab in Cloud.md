...
Windows user can use the following command
```
...
Windows user will be getting and ASCII art logo of Amazon Linux shown as below indicating that you've successfully connected to your Amazon EC2 instance running Amazon Linux 2023.
...
```
Window user can use below command. The 'apt' package manager is not available on Amazon Linux instance. It is basically used in Debian- based distributions like Ubuntu. For Amazon Linux we can use 'yum' package manager.
```
