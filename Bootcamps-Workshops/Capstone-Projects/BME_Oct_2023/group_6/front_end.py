...
import requests
import os 
import json# Import the os module for file handling
...
if uploaded_file is not None:
    ...
    if st.button("Transcribe"):
        ...
        files = {'file': (uploaded_file.name, open(image_path, 'rb'), 'image/jpeg')}
        
        response = requests.post('http://13.233.246.91:7006/upload-file/', files=files)
